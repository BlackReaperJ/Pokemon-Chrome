...
public enum Images implements ImgPathConstants {
	...
	Exitium(MAP_PATH + "/Exitium.png"), Route1(MAP_PATH + "/Route1.png"), House1Top(
			...
			+ "/MiracleForest2.png"), MiracleForest3(MAP_PATH
			+ "/MiracleForest3.png"), MiracleForest4(MAP_PATH
			+ "/MiracleForest4.png"), MiracleForest5(MAP_PATH
			+ "/MiracleForest5.png"), MapleLodge(MAP_PATH + "/MapleLodge.png"), MoveTester(
