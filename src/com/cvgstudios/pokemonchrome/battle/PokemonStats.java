...
public class PokemonStats {
	public static int baseHp, baseAtk, baseDef, baseSpAtk, baseSpDef,
			baseSpeed;// Pokemon Base Stats
	public static String type = "";
	public static int statAtk, statDef, statSpAtk, statSpDef, statSpeed;// Pokemon
																		// Final
																		// Stats
	public static double atkPercent = 1, defPercent = 1, spAtkPercent = 1,
			spDefPercent = 1, speedPercent = 1;
	public static int stgAtk = 0, stgDef = 0, stgSpAtk = 0, stgSpDef = 0,
			stgSpeed = 0;
