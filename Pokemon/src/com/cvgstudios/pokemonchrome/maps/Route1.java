...
public class Route1 extends JFrame implements ActionListener {
	...
	URL imageURL = cl.getResource("Pictures/Maps/Route1.png"),
			...
			imageURL14 = cl.getResource("Pictures/Maps/Exitium.png"),
			imageURL15 = cl
					.getResource("Pictures/Sprites/Structures/ColumnTrees.png"),
			imageURL16 = cl.getResource("Pictures/Sprites/Misc/Pokeball3.png"),
			imageURL17 = cl
					.getResource("Pictures/Sprites/NPC/Trainer1/Trainer1Right.png"),
			imageURL18 = cl
					.getResource("Pictures/Sprites/NPC/Trainer1/Trainer1Right1.png"),
			imageURL19 = cl
					.getResource("Pictures/Sprites/NPC/Trainer1/Trainer1Right2.png"),
			imageURL20 = cl
					.getResource("Pictures/Sprites/NPC/Trainer1/Trainer1Left.png"),
			imageURL21 = cl
					.getResource("Pictures/Sprites/NPC/Trainer1/Trainer1Left1.png"),
			imageURL22 = cl
					.getResource("Pictures/Sprites/NPC/Trainer1/Trainer1Left2.png"),
			imageURL23 = cl
					.getResource("Pictures/Sprites/NPC/Trainer2/Trainer2Right.png"),
			imageURL24 = cl
					.getResource("Pictures/Sprites/NPC/Trainer2/Trainer2Right1.png"),
			imageURL25 = cl
					.getResource("Pictures/Sprites/NPC/Trainer2/Trainer2Right2.png"),
			imageURL26 = cl
					.getResource("Pictures/Sprites/NPC/Trainer2/Trainer2Left.png"),
			imageURL27 = cl
					.getResource("Pictures/Sprites/NPC/Trainer2/Trainer2Left1.png"),
			imageURL28 = cl
					.getResource("Pictures/Sprites/NPC/Trainer2/Trainer2Left2.png"),
			imageURL29 = cl
					.getResource("Pictures/Sprites/Structures/PileBlock.png"),
			imageURL30 = cl
					.getResource("Pictures/Sprites/NPC/Gate/Gate2Left.png"),
			imageURL31 = cl
					.getResource("Pictures/Sprites/NPC/Gate/Gate2Down.png"),
			imageURL32 = cl.getResource("Pictures/Maps/MapleLodge.png");
