...
public class GameFile {
  ...
  /* 0 - Your initial pokemon, decides friends' pokemons
   * 1 - meeting frien,Jayce at start
   * 2 - talking to your dad at start
  ...
  public static int iBattle;// 1- Wild Pokemon, 2-Trainers, 3-Friends and Gyms, 4- Double Battles
...
//    System.out.println("I AM LOADING!");
    try {
      ...
      while (fileReader.hasNextLine()){
        ...
        if (!bNameGot && struLineParsing.startsWith("Name(") && struLineParsing.endsWith(")")){
          strPlayerName = struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'));
          bNameGot = true;
        } else if (!bGenderGot && struLineParsing.startsWith("Gender(") && struLineParsing.endsWith(")")){
          strPlayerGender = struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'));
          bGenderGot = true;
        } else if (!bTimeGot && struLineParsing.startsWith("TimePlayed(") && struLineParsing.endsWith(")")){
          lTimePlayed = Long.parseLong(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')')));
          bTimeGot = true;
        } else if (!bLocationGot && struLineParsing.startsWith("Location(") && struLineParsing.endsWith(")")){
          iLocation = Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')')));
          bLocationGot = true;
        } else if (!bBattleGot && struLineParsing.startsWith("Battle(") && struLineParsing.endsWith(")")){
          iBattle = Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')')));
          bBattleGot = true;
        } else if (!bPokemonNameGot && struLineParsing.startsWith("PokemonName(") && struLineParsing.endsWith(")")){
          strPokemonName = struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'));
          bPokemonNameGot = true;
        } else if (struLineParsing.startsWith("Badge(") && struLineParsing.endsWith(")")){
          stralBadgesInFile.add(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')')));
        } else if (struLineParsing.startsWith("GameVar(") && struLineParsing.endsWith(")") && iuDataAt < GAME_VAR_AMOUNT){
          iaGameVars[iuDataAt] = (Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'))));
          iuDataAt ++;
        } else if (struLineParsing.startsWith("PokemonLevels(") && struLineParsing.endsWith(")") && iuDataAt4 < POKEMON_LEVELS_AMOUNT){
          pokemonLevels[iuDataAt4] = (Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'))));
          iuDataAt4 ++;
        } else if (struLineParsing.startsWith("PokemonParty(") && struLineParsing.endsWith(")") && iuDataAt1 < POKEMON_PARTY_AMOUNT){
          pokemonParty[iuDataAt1] = struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'));
          iuDataAt1 ++;
        } else if (struLineParsing.startsWith("PokemonExp(") && struLineParsing.endsWith(")") && iuDataAt11 < POKEMON_EXP_AMOUNT){
          pokemonExp[iuDataAt11] = (Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'))));
          iuDataAt11 ++;
        } else if (struLineParsing.startsWith("Pokemon1IVsStats(") && struLineParsing.endsWith(")") && iuDataAt6 < POKEMON1_IVS_AMOUNT){
          pokemon1Ivs[iuDataAt6] = (Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'))));
          iuDataAt6 ++;
        } else if (struLineParsing.startsWith("PokemonCurrentHp(") && struLineParsing.endsWith(")") && iuDataAt9 < POKEMON_HP_AMOUNT){
          pokemonHp[iuDataAt9] = (Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'))));
          iuDataAt9 ++;
        } else if (struLineParsing.startsWith("PokemonFullHp(") && struLineParsing.endsWith(")") && iuDataAt10 < POKEMON_FULLHP_AMOUNT){
          pokemonFullHp[iuDataAt10] = (Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'))));
          iuDataAt10 ++;
        } else if (struLineParsing.startsWith("Enemy1IVsStats(") && struLineParsing.endsWith(")") && iuDataAt8 < ENEMY1_IVS_AMOUNT){
          enemy1Ivs[iuDataAt8] = (Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'))));
          iuDataAt8 ++;
        } else if (struLineParsing.startsWith("Pokemon1MoveSet(") && struLineParsing.endsWith(")") && iuDataAt3 < POKEMON_MOVES1_AMOUNT){
          pokemon1MoveSet[iuDataAt3] = struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'));
          iuDataAt3 ++;
        } else if (struLineParsing.startsWith("Enemy1MoveSet(") && struLineParsing.endsWith(")") && iuDataAt7 < ENEMY_MOVES1_AMOUNT){
          enemy1MoveSet[iuDataAt7] = struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'));
          iuDataAt7 ++;
        } else if (struLineParsing.startsWith("EnemyParty(") && struLineParsing.endsWith(")") && iuDataAt2 < ENEMY_PARTY_AMOUNT){
          enemyParty[iuDataAt2] = struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'));
          iuDataAt2 ++;
        } else if (struLineParsing.startsWith("EnemyLevels(") && struLineParsing.endsWith(")") && iuDataAt5 < ENEMY_LEVELS_AMOUNT){
          enemyLevels[iuDataAt5] = (Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'))));
          iuDataAt5 ++;
        } else if (!bTrainerNameGot && struLineParsing.startsWith("TrainerName(") && struLineParsing.endsWith(")")){
          strTrainerName = struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')'));
          bTrainerNameGot = true;
        }
        else if (!bWin && struLineParsing.startsWith("Win(") && struLineParsing.endsWith(")")){
          iWin = Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')')));
          bWin = true;
        }
          else if (!bLocXGot && struLineParsing.startsWith("XLocation(") && struLineParsing.endsWith(")")){
          iLocX = Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')')));
          bLocXGot = true;
        } else if (!bLocYGot && struLineParsing.startsWith("YLocation(") && struLineParsing.endsWith(")")){
          iLocY = Integer.parseInt(struLineParsing.substring(struLineParsing.indexOf('(') + 1, struLineParsing.indexOf(')')));
          bLocYGot = true;
        } 
  ...
  /* public static int ccord(int cord){
   return 300 - cord;
   }
   */
}